...
.smart-green .button:hover {
	...
	<div id="registrationform">
		<form action="UserRegister" method="post" class="smart-green">
			<h1>
				Registration Form <span style="font-size: 20">Please fill all
					the texts in the fields.</span>
			</h1>
			<label> <span>First Name :</span> <input id="name"
				type="text" name="firstname" required />
			</label> <label> <span>Last Name :</span> <input id="name"
				type="text" name="lastname" />
			</label> <label> <span>Username :</span> <input id="name" type="text"
				name="username" required />
			</label> <label> <span>Password :</span> <input id="password"
				type="password" name="password" required />
			</label> <label> <span>Contact Number (10 digits):</span> <input
				id="name" type="number" name="cnumber" required />
			</label> <label> <span>Account Number (16 digits):</span> <input
				id="name" type="text" name="anumber" required />
			</label> <label> <span>Age (in years) :</span> <input id="name"
				type="number" name="age" required />
			</label> <label> <span>E-mail :</span> <input id="email" type="email"
				name="mailid" required />
			</label> <label> <span>Sex :</span> <input type="radio" name="sex"
				value="male">Male<br> <input type="radio" name="sex"
				value="female" required>Female<br>
			</label> <label> <span>Branch :</span> <select name="branch" required>
					<option value="trinagar">Tri Nagar</option>
					<option value="pitampura">Pitampura</option>
					<option value="rajourigarden" selected>Rajouri Garden</option>
